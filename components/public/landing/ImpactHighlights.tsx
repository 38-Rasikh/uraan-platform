        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {latestProject ? (
            <Link
              ...
              className="hover:border-[--color-accent]/60 group rounded-xl border border-zinc-700 bg-zinc-800 p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md"
            >
              ...
              <h3 className="mb-2 text-lg font-semibold text-white transition-colors group-hover:text-[--color-accent]">
                {latestProject.title}
              </h3>
              {latestProject.tagline && (
                <p className="mb-4 line-clamp-2 text-sm text-zinc-300">{latestProject.tagline}</p>
              )}
            ...
            <div className="rounded-xl border border-zinc-700 bg-zinc-800 p-6 shadow-sm">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[--color-accent-muted]">
                <Award className="h-5 w-5 text-[--color-accent]" />
              </div>
          ...
          {/* Card 2: Impact Stat */}
          <div className="rounded-xl border border-zinc-700 bg-zinc-800 p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[--color-accent-muted]">
            ...
            <p className="mb-4 text-4xl font-bold text-white">{totalChildren.toLocaleString()}</p>
          ...
          <Link
            href="/directory"
            className="hover:border-[--color-accent]/60 group rounded-xl border border-zinc-700 bg-zinc-800 p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md sm:col-span-2 lg:col-span-1"
          >
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-[--color-accent-muted]">
